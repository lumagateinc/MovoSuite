...
- **#4 Create an Exchange Online mailbox for sending email notifications**. This should be a User Mailbox or a Shared Mailbox, but cannot be an Office 365 Group mailbox due to limitations in Microsoft Graph today.
