...
- **Step 1: Complete and verify the prerequisites**. Full list of prerequisites [HERE](#setup/prereqs).
...
- **Step 8: Test MovoSuite Functionality**. [HERE](#selfservice) Try deploying an app to one of your devices, and test the purchase form.
